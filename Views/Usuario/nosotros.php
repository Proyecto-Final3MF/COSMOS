...
<section class="equipo-container fade-slide">
    ...
    <a href="https://github.com/AlfreThiago">
    <div class="miembro">
    ...
    <a href="https://github.com/SerDan40">
    <div class="miembro">
        <img src="Assets/imagenes/perfil/elsergio.jpeg" alt="Miembro 4">
        <h3>Sergio <br> Lopez</h3>
    </div>
    </a>

    <a href="https://github.com/VectorAlonne">
    <div class="miembro">
        <img src="Assets/imagenes/perfil/ellucas.jpeg" alt="Miembro 5">
        <h3>Lucas <br> Vargas</h3>
    </div>
    </a>

    <a href="https://github.com/FrancoFagundez">
    <div class="miembro">
